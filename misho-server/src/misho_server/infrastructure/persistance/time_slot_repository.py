...
from misho_server.core.time_slot.time_slot_repository import TimeSlotRepository
...
from misho_server.infrastructure.persistance.hour_slot_repository import list_hour_slots
from misho_server.infrastructure.persistance.hour_slot_repository import to_domain as hour_slot_to_domain

type TimeSlotId = int


class TimeSlotRepositorySqlite(TimeSlotRepository):
