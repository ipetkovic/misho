...
from misho_server.infrastructure.persistance.jobs_repository import to_domain as job_to_domain
from misho_server.infrastructure.persistance.time_slot_repository import to_domain as time_to_domain
