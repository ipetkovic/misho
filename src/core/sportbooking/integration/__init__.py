import httpx
from core.sportbooking.integration import reservation_input
from core.sportbooking.integration.login import LoginResponse
from core.sportbooking.integration.reservation_calendar import get_reservation_calendar
