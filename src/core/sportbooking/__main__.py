...
# from core.sportbooking.repository.reservation_calendar import ReservationCalendarRepository, ReservationCalendarRepositorySqlite
...
# from core.sportbooking.service.job_event import JobEventBus, JobEventPublisher, JobEventSubscriber
# from core.sportbooking.service.job_executor import JobExecutor
# from core.sportbooking.service.job_orchestrator import JobOrchestrator
# from core.sportbooking.service.job_poll_service import JobPollService
# from core.sportbooking.service.job_scheduler import JobSchedulerScoped
# from core.sportbooking.service.refresh_user_token_job_executor import RefreshUserTokenJobExecutor
...
#     user_repository = UserRepositorySqlite(db)
#     user_token_repository = UserTokenRepositorySqlite(db)

#     job_repository = JobsRepositorySqlite(db)

#     reservation_calendar_repository = ReservationCalendarRepositorySqlite(db)

#     session_token_fetch_service = SessionTokenFetchService(user_repository=user_repository,
...
#     job_event_publisher = JobEventPublisher(job_event_bus)
#     job_event_subscriber = JobEventSubscriber(job_event_bus)

#     job_poll_service = JobPollService(job_repository, job_event_publisher)
#     reservation_monitoring = ReservationMonitoring(
#         reservation_config=CONFIG.reservation_monitoring,
#         user_repository=user_repository,
#         reservation_calendar_repository=reservation_calendar_repository,
#         token_fetch_service=session_token_fetch_service
#     )

#     with JobSchedulerScoped() as scheduler:

#         reserve_job_executor = ReserveJobExecutor(
#             job_repository, reservation_service)
#         refresh_user_token_job_executor = RefreshUserTokenJobExecutor(
#             session_token_fetch_service)
#         job_executor = JobExecutor(reserve_job_executor=reserve_job_executor,
#                                    refresh_user_token_job_executor=refresh_user_token_job_executor)

#         job_orchestrator = JobOrchestrator(
#             job_event_subscriber=job_event_subscriber,
...
#         with job_poll_service, reservation_monitoring:
#             while True:
