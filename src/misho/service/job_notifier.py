from misho.domain.job_notification import JobNotification
from misho.repository.job_notifications_repository import JobNotificationsRepository
from misho.service import mail_service
