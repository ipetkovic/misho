...
from misho.domain.reservation_calendar import CourtReservation, ReservationCalendar
...
from misho.repository.time_slot import find_times_slots
from misho.repository.time_slot import to_domain as time_slot_to_domain
